...
## @type: DataSource
## @args: [database = "glue-transactionsdb", table_name = "bulkimport_bucket", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "glue-transactionsdb", table_name = "bulkimport_bucket", transformation_ctx = "datasource0")
## @type: ApplyMapping
